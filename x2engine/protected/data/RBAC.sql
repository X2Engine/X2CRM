...
('ChartsX2GridViewMassAction', 0, '', NULL, 'N;'),
('ChartsInlineEmail', 0, '', NULL, 'N;'),
...
('ChartsIndex', 'ChartsX2GridViewMassAction'),
('administrator','ChartsAdminAccess'),
('administrator','ChartsReadOnlyAccess'),
('ChartsReadOnlyAccess','ChartsDeleteNote'),
('ChartsReadOnlyAccess', 'ChartsInlineEmail'),
('DefaultRole','ChartsReadOnlyAccess'),
('ChartsAdminAccess','ChartsMinimumRequirements'),
('ChartsMinimumRequirements','ChartsGetFieldData'),
('ChartsMinimumRequirements','ChartsIndex'),
('ChartsReadOnlyAccess','ChartsLeadVolume'),
('ChartsReadOnlyAccess','ChartsMarketing'),
('ChartsReadOnlyAccess','ChartsMinimumRequirements'),
('ChartsReadOnlyAccess','ChartsPipeline'),
('ChartsReadOnlyAccess','ChartsSales'),
('ChartsMinimumRequirements','ChartsSearch'),
('ChartsReadOnlyAccess','ChartsWorkflow'),
...
('X2LeadsUpdateAccess','X2LeadsConvertLead'),
('X2LeadsBasicAccess','X2LeadsCreate'),
('X2LeadsBasicAccess','X2LeadsConvert'),
