...
('ContactsGetInlineEmailContacts', 0, '', NULL, 'N;'),
...
('AccountsLists',0,'',NULL,'N;'),
('AccountsGetLists',0,'',NULL,'N;'),
('AccountsList',0,'',NULL,'N;'),
('AccountsUpdateList',0,'',NULL,'N;'),
('AccountsCreateList',0,'',NULL,'N;'),
('AccountsDeleteList',0,'',NULL,'N;'),
...
('AccountsMyAccounts',0,'',NULL,'N;'),
('AccountsNewAccounts',0,'',NULL,'N;'),
...
('ActionsQuickUpdateGuest',0,'',NULL,'N;'),
...
('AdminOutlookSync',0,'',NULL,'N;'),
('AdminBounceHandlingSetup',0,'',NULL,'N;'),
('AdminLogAnalyzer',0,'',NULL,'N;'),
('AdminListProcesses',0,'',NULL,'N;'),
('AdminGetDashboardMetrics',0,'',NULL,'N;'),
('AdminCodeEditor',0,'',NULL,'N;'),
('AdminCodeBrowser',0,'',NULL,'N;'),
...
('AdminOutlookIntegration',0,'Permissions for integrating the application the Outlook.',NULL,'N;'),
...
('CalendarAppointment',0, '',NULL,'N;'),
('CalendarEditActionGuest',0,'',NULL,'N;'),
('CalendarJsonFeedGuest',0,'',NULL,'N;'),
...
('ContactsConvert',0,'',NULL,'N;'),
('ContactsPublic',0,'',NULL,'N;'),
...
('guest',2,'Guest user','return Yii::app()->user->isLoggedOut;','N;'),
...
('MarketingFacebook',0,'',NULL,'N;'),
('MarketingFacebookRequest',0,'',NULL,'N;'),
('MarketingLists',0,'',NULL,'N;'),
('MarketingMyMarketing',0,'',NULL,'N;'),
('MarketingNewMarketing',0,'',NULL,'N;'),
('MarketingGetListModelAttr',0,'',NULL,'N;'),
('MarketingGetLists',0,'',NULL,'N;'),
('MarketingList',0,'',NULL,'N;'),
('MarketingUpdateList',0,'',NULL,'N;'),
('MarketingCreateList',0,'',NULL,'N;'),
('MarketingDeleteList',0,'',NULL,'N;'),
('MarketingUnsubscribe',0,'',NULL,'N;'),
('MarketingUnsubWebleadForm',0,'',NULL,'N;'),
('MarketingLongTermCampaignCreate',0,'',NULL,'N;'),
('MarketingA_B_CampaignCreate',0,'',NULL,'N;'),
('MarketingMakeFull',0,'',NULL,'N;'),
('MarketingUpdateBouncedEmails',0,'',NULL,'N;'),
('MarketingLandingPages',0,'',NULL,'N;'),
...
('MarketingGetHeatMapData',0,'View embed code for web tracker.',NULL,'N;'),
('MediaAdmin',0,'',NULL,'N;'),
...
('OpportunitiesGetLists',0,'',NULL,'N;'),
('OpportunitiesMyOpportunity',0,'',NULL,'N;'),
('OpportunitiesNewOpportunity',0,'',NULL,'N;'),
...
('OpportunitiesMyOpportunities',0,'',NULL,'N;'),
('OpportunitiesNewOpportunities',0,'',NULL,'N;'),
...
('X2LeadsMyX2Leads',0,'',NULL,'N;'),
('X2LeadsNewX2Leads',0,'',NULL,'N;'),
('OpportunitiesPrivateFullAccess',1,'',NULL,'N;'),
('ProductsLists',0,'',NULL,'N;'),
('ProductsGetLists',0,'',NULL,'N;'),
('ProductsList',0,'',NULL,'N;'),
('ProductsUpdateList',0,'',NULL,'N;'),
('ProductsCreateList',0,'',NULL,'N;'),
('ProductsDeleteList',0,'',NULL,'N;'),
...
('ReportsLists',0,'',NULL,'N;'),
('ReportsGetLists',0,'',NULL,'N;'),
('ReportsList',0,'',NULL,'N;'),
('ReportsUpdateList',0,'',NULL,'N;'),
('ReportsCreateList',0,'',NULL,'N;'),
('ReportsDeleteList',0,'',NULL,'N;'),
('ReportsForecastReport',0,'',NULL,'N;'),
...
('ServicesLists',0,'',NULL,'N;'),
('ServicesGetLists',0,'',NULL,'N;'),
('ServicesList',0,'',NULL,'N;'),
('ServicesUpdateList',0,'',NULL,'N;'),
('ServicesCreateList',0,'',NULL,'N;'),
('ServicesDeleteList',0,'',NULL,'N;'),
...
('WorkflowTerminateProcess', 0,'',NULL,'N;'),
...
('BugReportsLists',0,'',NULL,'N;'),
('BugReportsGetLists',0,'',NULL,'N;'),
('BugReportsList',0,'',NULL,'N;'),
('BugReportsUpdateList',0,'',NULL,'N;'),
('BugReportsCreateList',0,'',NULL,'N;'),
('BugReportsDeleteList',0,'',NULL,'N;'),
...
('OpportunitiesAddToList',0,'',NULL,'N;'),
('OpportunitiesCreateList',0,'',NULL,'N;'),
('OpportunitiesCreateListFromSelection',0,'',NULL,'N;'),
('OpportunitiesDeleteList',0,'',NULL,'N;'),
('OpportunitiesList',0,'',NULL,'N;'),
('OpportunitiesLists',0,'',NULL,'N;'),
('OpportunitiesRemoveFromList',0,'',NULL,'N;'),
('OpportunitiesUpdateList',0,'',NULL,'N;'),
('AccountsAddToList',0,'',NULL,'N;'),
('AccountsCreateListFromSelection',0,'',NULL,'N;'),
('AccountsRemoveFromList',0,'',NULL,'N;'),
('X2LeadsAddToList',0,'',NULL,'N;'),
('X2LeadsCreateList',0,'',NULL,'N;'),
('X2LeadsCreateListFromSelection',0,'',NULL,'N;'),
('X2LeadsDeleteList',0,'',NULL,'N;'),
('X2LeadsGetLists',0,'',NULL,'N;'),
('X2LeadsList',0,'',NULL,'N;'),
('X2LeadsLists',0,'',NULL,'N;'),
('X2LeadsRemoveFromList',0,'',NULL,'N;'),
('X2LeadsUpdateList',0,'',NULL,'N;');
/*&*/
...
('ContactsMinimumRequirements', 'ContactsGetInlineEmailContacts'),
...
('MarketingBasicAccess','MarketingGetHeatMapData'),
...
('GuestSiteFunctionsTask','ActionsQuickUpdateGuest'),
('GuestSiteFunctionsTask','CalendarJsonFeedGuest'),
('GuestSiteFunctionsTask','CalendarAppointment'),
('GuestSiteFunctionsTask','CalendarEditActionGuest'),
('GuestSiteFunctionsTask','ActionsCaptcha'),
...
('AuthenticatedSiteFunctionsTask','WorkflowTerminateProcess'),
...
('AuthenticatedSiteFunctionsTask','WorkflowGetLists'),
...
('OpportunitiesPrivateUpdateAccess','OpportunitiesUpdateList'),
('OpportunitiesUpdateAccess','OpportunitiesUpdateList'),
('OpportunitiesUpdateAccess','OpportunitiesRemoveFromList'),
('OpportunitiesUpdatePrivate','OpportunitiesRemoveFromList'),
('OpportunitiesMinimumRequirements','OpportunitiesList'),
('OpportunitiesMinimumRequirements','OpportunitiesLists'),
('OpportunitiesMinimumRequirements','OpportunitiesGetLists'),
('OpportunitiesDeletePrivate','OpportunitiesDeleteList'),
('OpportunitiesFullAccess','OpportunitiesDeleteList'),
('OpportunitiesBasicAccess','OpportunitiesCreateList'),
('OpportunitiesBasicAccess','OpportunitiesCreateListFromSelection'),
('OpportunitiesBasicAccess','OpportunitiesAddToList'),
('AccountsPrivateUpdateAccess','AccountsUpdateList'),
('AccountsUpdateAccess','AccountsUpdateList'),
('AccountsUpdateAccess','AccountsRemoveFromList'),
('AccountsUpdatePrivate','AccountsRemoveFromList'),
('AccountsMinimumRequirements','AccountsList'),
('AccountsMinimumRequirements','AccountsLists'),
('AccountsMinimumRequirements','AccountsGetLists'),
('AccountsDeletePrivate','AccountsDeleteList'),
('AccountsFullAccess','AccountsDeleteList'),
('AccountsBasicAccess','AccountsCreateList'),
('AccountsBasicAccess','AccountsCreateListFromSelection'),
('AccountsBasicAccess','AccountsAddToList'),('X2LeadsPrivateUpdateAccess','X2LeadsUpdateList'),
('X2LeadsUpdateAccess','X2LeadsUpdateList'),
('X2LeadsUpdateAccess','X2LeadsRemoveFromList'),
('X2LeadsUpdatePrivate','X2LeadsRemoveFromList'),
('X2LeadsMinimumRequirements','X2LeadsList'),
('X2LeadsMinimumRequirements','X2LeadsLists'),
('X2LeadsMinimumRequirements','X2LeadsGetLists'),
('X2LeadsDeletePrivate','X2LeadsDeleteList'),
('X2LeadsFullAccess','X2LeadsDeleteList'),
('X2LeadsBasicAccess','X2LeadsCreateList'),
('X2LeadsBasicAccess','X2LeadsCreateListFromSelection'),
('X2LeadsBasicAccess','X2LeadsAddToList');
