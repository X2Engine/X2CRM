...
('AccountsUpdatePrivate',1,'Update their own records','return Yii::app()->suName==$params[\'assignedTo\'];','N;'),
('AccountsView',0,'',NULL,'N;'),
('AccountsViewPrivate',1,'View their own records','return Yii::app()->suName==$params[\'assignedTo\'];','N;'),
...
('ActionsDeletePrivate',1,'Delete assigned records','return Yii::app()->suName==$params[\'assignedTo\'];','N;'),
...
('ActionsUpdatePrivate',1,'Update assigned records.','return Yii::app()->suName==$params[\'assignedTo\'];','N;'),
