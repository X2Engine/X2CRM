...
Etiam eget iaculis nisl. Duis id malesuada orci. Mauris imperdiet ut elit rhoncus finibus. Mauris lacinia non sem a suscipit. Etiam id nibh sit amet nunc suscipit dictum ut eget.',
    ...
    public function testFormatMedia() {
        ...
        $text = $event->getText();
        $this->assertNotEmpty($text);
        $this->assertEquals('<a href="http://localhost/index-test.php/profile/1">You</a>: <br>File: <a href="/index-test.php/media/view/1">Divers.jpg</a><br><img class="attachment-img" src="http://localhost/index-test.php/media/media/getFile/1/key/d84e7834f79223ad17981fe3f9e61b12ae5c012345cbc29bcfe1d7b982edc9b9" alt="" />',
                $text);

        $truncatedText = $event->getText(array('truncated' => true));
        $this->assertNotEmpty($truncatedText);
        $this->assertEquals('<a href="http://localhost/index-test.php/profile/1">You</a>: <br>File: <a href="/index-test.php/media/view/1">Divers.jpg</a>',
                $truncatedText);
