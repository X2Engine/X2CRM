    ...
    <div class="form">
        ...
        <span class="mock-x2-form-label"><?php echo Yii::t('admin','Manual / Offline Update'); ?></span><br />
                ...
                <ul>
                    ...
                    <li><?php echo CHtml::link(Yii::t('admin','Latest Updater Utility Patch'),$edition=='opensource' ? "http://52.33.121.218/x2planet.com/installs/updater.zip" : "http://52.33.121.218/x2planet.com/installs/{$uniqueId}/updater-{$edition}.zip");?></li>
                    <li><?php echo CHtml::link(Yii::t('admin','File Set Refresh Package'),$edition=='opensource'?"http://52.33.121.218/x2planet.com/installs/refresh.zip":"http://52.33.121.218/x2planet.com/installs/{$uniqueId}/refresh-{$edition}.zip");?></li>
