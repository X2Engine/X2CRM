...
echo CHtml::image(
    ...
    Yii::t('app', 'Loading'), array('id' => 'email-sending-icon'));
$emailSent = false;
...
<?php echo $form->label($this->model, 'credId', array('class' => 'x2-email-label')); ?>
        ...
        <div class="row email-input-row">
            ...
            echo $form->textField(
                $this->model, 'subject', array('style' => 'width: 265px;', 'tabindex' => '4')); 
            //if ($templatesEnabled) {
        ...
        <div class="row" id="email-attachments">
            <div class="form" style="text-align:left;background:none;overflow:visible;">
                <b><?php echo Yii::t('app', 'Attach a File'); ?></b>
                <br />
                <?php 
                if (isset ($attachments)) { // is this a refreshed form with previous attachments?  
                    ...
                    <div>
                        ...
                        <input type="hidden" name="AttachmentFiles[temp][]" 
                         value="<?php echo ($attachment['temp'] ? "true" : "false"); ?>">
                        ...
                        <span class="x2-file-wrapper">
                            ...
                            echo CHtml::image(
                                ...
                                array(
                                    ...
                                    'style' => 'position: absolute; width: 14px; height: 14px; filter: alpha(opacity=0); -moz-opacity: 0.00; opacity: 0.00;'
                                )); 
                            ?>
                        </span>
