...
VALUES
('Docs','createDate','Created',0,0,'date',0,1,NULL,0,NULL,0),
('Docs','createdBy','Created By',0,0,'varchar',0,1,NULL,0,NULL,0),
('Docs','editPermissions','Edit Permissions',0,0,'varchar',0,1,NULL,0,NULL,0),
('Docs','id','ID',0,0,'int',0,1,NULL,0,NULL,0),
('Docs','lastUpdated','Last Updated',0,0,'date',0,1,NULL,0,NULL,0),
...
('Docs','updatedBy','Updated By',0,0,'link',0,1,'User',0,NULL,0),
('Docs','visibility','Visibility',0,0,'visibility',0,0,NULL,0,NULL,0);
