        ...
        $displayColumns = array_merge ($displayColumns, array(
            array(
                ...
                'value' => '!empty($data["preferredEmail"]) ? 
                            ...
                            (!empty($data["email"])) ?  
                            $data["email"] : (!empty($data["emailAddress"]) ? 
                            $data["emailAddress"] : "") : ($data["preferredEmail"] == "businessEmail") ?
                            (!empty($data["businessEmail"])) ? 
                            $data["businessEmail"] : (!empty($data["emailAddress"]) ? 
						    $data["emailAddress"] : "") : ($data["preferredEmail"] == "personalEmail") ?
					        (!empty($data["personalEmail"])) ? 
						    $data["personalEmail"] : (!empty($data["emailAddress"]) ? 
							$data["emailAddress"] : "")	: (!empty($data["alternativeEmail"])) ? 
						    $data["alternativeEmail"] : (!empty($data["emailAddress"]) ? 
							$data["emailAddress"] : "")	: (!empty($data["email"])) ? 
                    	    $data["email"] : (!empty($data["emailAddress"]) ? 
				            $data["emailAddress"] : "")',
            ),
            array(
