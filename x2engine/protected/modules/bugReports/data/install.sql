...
VALUES
("BugReports",	"id",				"ID",					0,		"int",			0,			0,			NULL,		0,			0,			"",         1,              1),
...
("BugReports",	"line",				"Line",					0,		"varchar",		0,			0,			NULL,		0,			0,			"",         0,              1),
("BugReports",	"phpVersion",		"PHP Version",			0,		"varchar",		0,			0,			NULL,		0,			0,			"",         0,              1),
("BugReports",	"severity",         "Severity",             0,		"dropdown",		0,			0,			116,		0,			0,			"",         0,              1),
("BugReports",	"status",           "Status",               0,		"dropdown",		0,			0,			115,		0,			0,			"",         0,              1),
("BugReports",	"subject",			"Subject",				0,		"varchar",		0,			0,			NULL,		0,			0,			"",         0,              1),
("BugReports",	"type",				"Type",					0,		"varchar",		0,			0,			NULL,		0,			0,			"",         0,              1),
("BugReports",	"visibility",		"Visibility",			0,		"visibility",	0,			0,			NULL,		0,			0,			"",         0,              1),
("BugReports",	"x2Version",		"X2 Version",			0,		"varchar",		0,			0,			NULL,		0,			0,			"",         0,              1),
("BugReports",	"errorCode",		"Error Code",			0,		"varchar",		0,			0,			NULL,		0,			0,			"",         0,              1);
/*&*/
