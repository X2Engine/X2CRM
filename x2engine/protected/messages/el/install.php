...
'Welcome to the X2CRM application installer! We need to collect a little information before we can get your application up and running. Please fill out the fields listed below.'=>'Καλώς ήλθατε στον οδηγό εγκατάστασης της X2CRM! Χρειάζονται κάποιες πληροφορίες πρώτα για να λειτουργήσει σωστά η εφαρμογή. Παρακαλούμε, συμπληρώστε τα πεδία που εμφανίζονται πιο κάτω.',
'X2CRM Application Info'=>'Πληροφορίες Εφαρμογής X2CRM',
...
'The "openssl" and "mcrypt" libraries are not available. If any application credentials (i.e. email account passwords) are entered into X2CRM, they  will be stored in the database in plain text (without any encryption whatsoever). Thus, if the database is ever compromised, those passwords will be readable by unauthorized parties.'=>'Οι &quot;OpenSSL&quot; και &quot;mcrypt&quot; βιβλιοθήκες δεν είναι διαθέσιμες. Εάν οι πιστοποιήσεις κάποιας εφαρμογής (π.χ. κωδικών πρόσβασης του λογαριασμού e-mail) εισαχθούν στην X2CRM, θα αποθηκευθούν στη βάση δεδομένων με μορφή απλού κειμένου (χωρίς απολύτως καμία κρυπτογράφηση). Έτσι, εάν τυχόν η βάση δεδομένων εκτεθεί, αυτοί οι κωδικοί πρόσβασης θα είναι αναγνώσιμοι από μη εξουσιοδοτημένους τρίτους.',
'Connection successful!'=>'Σύνδεση επιτυχής!',
'This webserver can run X2CRM!'=>'Αυτός ο διακομιστής μπορεί να τρέξει την X2CRM!',
...
'The function proc_open and/or the "mysqldump" and "mysql" command line utilities are unavailable on this system. X2CRM will not be able to automatically make a backup of its database during software updates, or automatically restore its database in the event of a failed update.'=>'Η λειτουργία proc_open και/ή τα &quot;mysqldump&quot; και &quot;mysql&quot;, βοηθητικά προγράμματα της γραμμής εντολών δεν είναι διαθέσιμα σε αυτό το σύστημα. Η X2CRM δεν θα είναι σε θέση να κάνει αυτόματα αντίγραφα ασφαλείας της βάσης δεδομένων κατά τη διάρκεια ενημερώσεων του λογισμικού, ή αυτόματα αποκατάσταση της βάσης δεδομένων, σε περίπτωση αποτυχίας της διαδικασίας ενημερωσης.',
