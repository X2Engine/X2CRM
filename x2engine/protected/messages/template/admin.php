...
'Google integration allows users to link their calendars on x2crm with Google Calendars as well as log in with their Google IDs.'=>'',
...
'X2CRM is at the latest version!'=>'',
'Go back'=>'',
...
'Introduction'=>'',
'This feature allows X2CRM to receive and record emails at a special address.'=>'',
...
'Before beginning, please see the {emailConfig} page on the X2CRM Wiki.'=>'',
...
'If disabled, the email dropbox will ignore any emails that are to or from addresses not matching any contacts in X2CRM. If enabled, new contacts will be created automatically using name info contained in the email.'=>'',
...
'This page will export all data from all modules into a CSV file. This CSV can be re-imported to another X2CRM installation as is without any formatting changes.'=>'',
'Available Models'=>'',
'({n} records)'=>'',
...
'Qmail'=>'',
'User account'=>'',
'Configure how X2CRM sends email when mailing en-masse.'=>'',
'Group signature'=>'',
...
'Failed to copy one or more files from {dir} into X2CRM. You may need to copy them manually.'=>'',
...
'The Web Lead capture form is very useful if you have a public website. Visitors can submit their contact information and questions, and X2Contacts will automatically create contact records for them.'=>'',
...
'X2CRM needs to retrieve one or more remote files, but no remote access methods are available on this web server, because allow_url_fopen is disabled and the CURL extension is missing.'=>'',
...
'Upgrade X2CRM to Professional Edition; license key required.'=>'',
...
'Make a backup copy of X2CRM\'s database:'=>'',
...
'Note: your server may not meet all the necessary requirements to {scenario} X2CRM.'=>'',
...
'To stop this error from occurring, if the problem persists, restore the file {adminController} to the copy from your version of X2CRM:'=>'',
'Notification Email Settings'=>'',
'Configure how notification emails are sent.'=>'',
'This field is a MySQL or X2CRM reserved word.  Choose a different field name.'=>'',
...
'You '=>'',
' also '=>'',
'should use this if the CRM is behind a firewall and you access X2CRM using a different URL than one would use to access it from the internet (i.e. a host name / IP address on a private subnet or VPN).'=>'',
'To set up a website domain alias for tracking, you\'ll need to create a'=>'',
'For example, '=>'',
'For more information, see {config} on the X2CRM wiki.'=>'',
...
'Before beginning, please see {emailConfig} on the X2CRM Wiki.'=>'',
...
'As often as specified, X2CRM will check for updates and display a system notification message if a new version is available.'=>'',
'Update Automatically'=>'',
'If enabled, X2CRM will periodically check for updates and update automatically if a new version is available.'=>'',
...
'To update manually, if using X2CRM offline or if something goes wrong, see the instructions given in {wikilink}.'=>'',
'The X2CRM Update Guide'=>'',
...
'This feature is for shutting down X2CRM during periods of maintenance or whenever it might be favorable to prevent access and data entry. When the application is locked, it cannot be used except by the administrator, and all services (such as the web lead form and API) will be unavailable.'=>'',
'X2CRM is currently locked. Time it was locked: {time}'=>'',
'X2CRM is not currently locked.'=>'',
'Lock X2CRM'=>'',
...
'Cron Table'=>'',
'Control the interval at which X2CRM will check for and run scheuled tasks.'=>'',
'Convert Modules'=>'',
...
'Download package'=>'',
'Extract package'=>'',
'The updater is currently applying changes to X2CRM. If you interrupt it, you could cause SEVERE damage that may include (but would not be limited to) loss of data.'=>'',
'Initializing...'=>'',
'Make a backup copy of all X2CRM\'s files in addition to its database, in case you want to revert to the current version.'=>'',
...
'Run scheduled X2CRM tasks via web request'=>'',
...
'If the above link does not work, download the script from {link} and copy it to the web root of X2CRM. If the script produces a message saying that it cannot resolve the local server, consider disabling this and enabling the alternate scheduled task running method, below.'=>'',
'Run scheduled X2CRM tasks via command line interface'=>'',
...
'The package to be applied does not correspond to this version of X2CRM; it was meant for version {fv} and this installation is at version {av}.'=>'',
'The package to be applied does not correspond to this edition of X2CRM; it was meant for edition "{fe}" and this installation is edition "{ae}".'=>'',
...
'Major'=>'',
'Critical'=>'',
'Some requirements for running X2CRM at the latest version are not met on this server:'=>'',
