...
'Stars'=>'כוכבים',
'The Image Gallery widget currently does not support Internet Explorer. We are looking to resolve this issue for a later release of X2CRM.'=>'יישומון גלריית התמונות כרגע אינו תומך ב-Internet Explorer. אנחנו מחפשים כדי לפתור את הבעיה לשחרור מאוחר יותר של X2CRM.',
'File'=>'קובץ',
'Yesterday'=>'אתמול',
...
'X2CRM is undergoing maintenance; it has been locked by an administrator. Please try again later.'=>'X2CRM עובר תחזוקה; זה כבר ננעל על ידי מנהל מערכת. אנא נסה שוב מאוחר יותר.',
