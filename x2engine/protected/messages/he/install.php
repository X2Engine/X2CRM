...
'To trigger scheduled or delayed tasks automatically in X2CRM requires adding a task to the local cron table.'=>'כדי לעורר מתוכנן או מתעכב משימות באופן אוטומטי בX2CRM דורש הוספת משימה לשולחן cron המקומי.',
