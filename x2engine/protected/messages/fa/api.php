<?php
return array (
'No relationships found.'=>'روابط یافت نشد.',
'Such a relationship already exists.'=>'چنین رابطه در حال حاضر وجود دارد.',
'Successfully saved a relationship.'=>'یک رابطه با موفقیت ذخیره شد.',
'Failed to save relationship record for unknown reason.'=>'برای صرفه جویی در سابقه رابطه به دلیل ناشناخته شکست خورد.',
'{n} relationships deleted.'=>'{n} روابط حذف شده است.',
