...
'Stars'=>'ستاره ها',
'The Image Gallery widget currently does not support Internet Explorer. We are looking to resolve this issue for a later release of X2CRM.'=>'گالری عکس ویجت در حال حاضر اینترنت اکسپلورر پشتیبانی نمی کند. ما به دنبال حل و فصل این موضوع برای آزادی بعد از X2CRM.',
'File'=>'پرونده',
'Yesterday'=>'دیروز',
...
'X2CRM is undergoing maintenance; it has been locked by an administrator. Please try again later.'=>'X2CRM است که تحت تعمیر و نگهداری؛ از آن شده است توسط مدیر قفل شده است. لطفا دوباره تلاش کنید.',
