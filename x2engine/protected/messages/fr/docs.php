...
'Uploaded Docs'=>'Docs téléchargés',
'Make a copy'=>'Faites une copie',
'Edit Template:'=>'Modifier le modèle:',
'<b>Note:</b> You can use dynamic variables such as {firstName}, {lastName} or {phone} in your template. When you email a contact, these will be replaced by the appropriate value.'=>'<b>Note:</b> Vous pouvez utiliser des variables dynamiques telles que {firstName} , {lastName} ou {phone} dans votre modèle. Lorsque vous envoyez un contact, celles-ci seront remplacées par la valeur appropriée.',
