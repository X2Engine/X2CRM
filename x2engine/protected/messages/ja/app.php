...
'Pie Chart'=>'円グラフ',
'Stars'=>'スター',
'The Image Gallery widget currently does not support Internet Explorer. We are looking to resolve this issue for a later release of X2CRM.'=>'イメージギャラリーウィジェットは現在、Internet Explorerをサポートしていません。我々はX2CRMの今後のリリースで、この問題を解決しようとしている。',
'File'=>'ファイル',
'Yesterday'=>'昨日',
'Data Domain'=>'データ領域',
...
'X2CRM is undergoing maintenance; it has been locked by an administrator. Please try again later.'=>'X2CRMはメンテナンス中であり、それは、管理者によってロックされています。後で再試行してください。',
