<?php return array (
  ...
  'Error: renderModelAutocomplete: {modelClass} does not have X2LinkableBehavior' => '오류 : renderModelAutocomplete : {modelClass} X2LinkableBehavior이 없습니다',
  ...
  'This record already has an {aliasType} alias with the name "{alias}"' => '이 기록은 이미이 {aliasType} &quot;이름으로 별명 {alias} &quot;',
  'Alias Type' => '별칭 유형',
  'Alias' => '별명',
  'email' => '이메일',
  'phone' => '전화',
  ...
  'Failed to log time on {record}' => '시간을 기록하지 못했습니다 {record}',
  ...
  'Failed to log call on {record}' => '에 통화 기록하지 못했습니다 {record}',
  ...
  '{count} new messages were found and added to the translation files.' => '{count} 새로운 메시지를 발견하고 번역 파일에 추가되었습니다.',
  '{count} messages were added to the common file.' => '{count} 메시지는 공통 파일에 첨가 하였다.',
  '{count} messages were removed from other files.' => '{count} 메시지는 다른 파일에서 제거되었습니다.',
  '{count} messages were translated.' => '{count} 메시지가 번역했다.',
  '{count} characters were translated, resulting in approximately {cost} in fees to Google.' => '{count} 약의 결과로, 문자가 번역 한 {cost} 구글에 수수료.',
  '{count} messages were translated for {lang}.' => '{count} 메시지에 대한 번역 된 {lang} .',
  'Automated translation complete.' => '자동 번역 완료.',
  'Error - Unable to find the following requested translation files:' => '오류 - 다음과 같은 요구 번역 파일을 찾을 수 없습니다 :',
  ...
  'Reply ' => '대답',
  '{count} messages needed to be translated.' => '{count} 번역 될 필요가 메시지를.',
  'Limit reached. Untranslated messages still remain.' => '한계에 도달했습니다. 번역되지 않은 메시지는 여전히 남아있다.',
  'Topics' => '주제',
  'Clock' => '시계',
