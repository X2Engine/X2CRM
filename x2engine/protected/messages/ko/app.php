...
'Your X2CRM session has expired. You may select "cancel" to ignore this message and recover unsaved data from the current page. Otherwise, you will be redirected to the login page.'=>'귀하의 X2CRM 세션이 만료되었습니다. 이 메시지를 무시하고 현재 페이지에서 저장되지 않은 데이터를 복구하려면 "취소"를 선택할 수 있습니다. 그렇지 않으면, 당신은 로그인 페이지로 리디렉션됩니다.',
...
'Pie Chart'=>'원형 차트',
'Stars'=>'별',
'The Image Gallery widget currently does not support Internet Explorer. We are looking to resolve this issue for a later release of X2CRM.'=>'이미지 갤러리 위젯은 현재 Internet Explorer를 지원하지 않습니다. 우리는 X2CRM의 이후 릴리스에 대해이 문제를 해결하기 위해 찾고 있습니다.',
'File'=>'파일',
'Yesterday'=>'어제',
'Data Domain'=>'데이터 도메인',
...
'X2CRM is undergoing maintenance; it has been locked by an administrator. Please try again later.'=>'X2CRM 유지 보수를 겪고있다, 그것은 관리자에 의해 잠겨 있습니다. 나중에 다시 시도하십시오.',
