...
You will also need to delete/remake any custom modules you have.

In the near future, (1.0 General Release) we will be implementing an automatic updater and these issues won't be present anymore.

Beta 0.9.2 Changelog

-X2Tags System Updated
-Changelog for Records
-Fixed some issues with hyperlinks
-Added page to view only your contacts
-Lots and lots of little bug fixes


Welcome to X2Contacts v0.9.2 Beta!  X2Contacts is a next-generation, open source social sales application for small and medium sized businesses. 
