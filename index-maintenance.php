...
if( preg_match('/index\.php\//',$_SERVER['REQUEST_URI'])) {
	header('Location: http://demo.x2engine.com');
}
?>
...
<script type="text/javascript">
	...
	<div id="installer-box">
	    ...
	    <h2 style="clear:none">Undergoing maintenance</h2>
		<p>The demo server has been temporarily disabled. Note, you can <a href="http://www.x2engine.com/trial-server/">set up a free trial</a>.</p>
	    <div id="footer">
